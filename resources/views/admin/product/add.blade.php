@extends('admin.layout.master')
  ...
  <title>Add Product - Kaldera Rent</title>
	@endsection
	@section('body')
  <div class="row">
    <div class="col-md-12">
            ...
            {{ csrf_field() }}
              <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control"  placeholder="Masukkan harga sewa" name="harga[{{$row->id}}]" required>
                </div>
                @endforeach
                <div class="form-group">
                    <label for="deposit_harga">Deposit Harga</label>
                    <input type="number" class="form-control"  placeholder="Masukkan deposit harga" name="deposit_harga" required>
                </div>
              </div>
              <!-- /.box-body -->
